...
def ff_gen_xyz(f,charge=0,residue_name='MOL',show=True, scf_basis='sto-3g',scf_conv = 1e-3,scf_xcfun = 'b3lyp',scf_maxiter = 30,no_RESP = False):
    ...
    ff_gen.ostream.mute()
    ff_gen.create_topology(m1, basis,scf_results,no_resp=no_RESP)
