...
from place_bbs import scaled_node_and_edge_vectors, place_edges,place_nodes_tri
...
class MOF_tri:
	...
	def term_defective_model(self,n_term_file = 'methyl.pdb',e_termfile = 'CCO2H2.pdb'):
		eG = self.eG
